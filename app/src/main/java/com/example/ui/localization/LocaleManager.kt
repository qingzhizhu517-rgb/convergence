...
object LocaleManager {
    private val enStrings = mapOf(
        ...
        "immersive_table_view" to "Fullscreen Immersive Table View",
        "close_immersive_view" to "Exit Immersive View"
    )
    ...
    private val zhStrings = mapOf(
        ...
        "immersive_table_view" to "横屏沉浸式查看",
        "close_immersive_view" to "退出全屏"
    )
